...
inner_min_itr = 50;
[Result1, ~] = RunRep(200,  50, 20, 0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[Result2, ~] = RunRep(500,  50, 20, 0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[Result3, ~] = RunRep(1000, 50, 20, 0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[Result4, ~] = RunRep(1500, 50, 20, 0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[Result5, ~] = RunRep(2000, 50, 20, 0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);


[Result6, ~]  = RunRep(1000, 50, 10,  0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[Result7, ~]  = RunRep(1000, 50, 15,  0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[Result8, ~]  = RunRep(1000, 50, 25,  0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[Result9, ~]  = RunRep(1000, 50, 30,  0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);

[Result10, ~]  = RunRep(1000, 50, 20,  0.05, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[Result11, ~]  = RunRep(1000, 50, 20,  0.15, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[Result12, ~]  = RunRep(1000, 50, 20,  0.20, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[Result13, ~]  = RunRep(1000, 50, 20,  0.25, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
inner_min_itr = 20;
[RResult1, ~] = RunRep(200,  50, 20, 0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[RResult2, ~] = RunRep(500,  50, 20, 0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[RResult3, ~] = RunRep(1000, 50, 20, 0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[RResult4, ~] = RunRep(1500, 50, 20, 0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[RResult5, ~] = RunRep(2000, 50, 20, 0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);

[RResult6, ~]  = RunRep(1000, 50, 10,  0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[RResult7, ~]  = RunRep(1000, 50, 15,  0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[RResult8, ~]  = RunRep(1000, 50, 25,  0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[RResult9, ~]  = RunRep(1000, 50, 30,  0.10, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);

[RResult10, ~]  = RunRep(1000, 50, 20,  0.05, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[RResult11, ~]  = RunRep(1000, 50, 20,  0.15, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[RResult12, ~]  = RunRep(1000, 50, 20,  0.20, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);
[RResult13, ~]  = RunRep(1000, 50, 20,  0.25, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);



path = strcat(pwd,'/RiAL_modified/results/CM/');
filename = 'CM_Apr19_data_v1.mat';
...
function [Result, out_ManALM] = RunRep(n, m, r, mu, start, reps, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr)
    ...
    for num = start:reps
        ...
        opts_ManALM.verbose = 0;
        t_ManALM = 0;
        t = tic;
        [U_ManALM, out_ManALM]= ManALM4CM_modified(phi_init, opts_ManALM, -A);
        ...
        % ================== RiALSD ===========================
        opts_RiALSD.tol = tol;
        opts_RiALSD.mxitr = 10000;
        opts_RiALSD.lasso_constant = mu;
        opts_RiALSD.sigma0 = sigma0_SD;
        ...
        opts_RiALSD.inner_min_itr = inner_min_itr;
        opts_RiALSD.sparse_param = sparse_param;
        opts_RiALSD.verbose = 0;

        t_RiALSD = 0;
        t = tic;
        [U_RiALSD, out_RiALSD]= RiAL_SD4CM(phi_init, opts_RiALSD, -A);
        ...
        t_RADA = 0;
        t = tic;
        [U_RADA, out_RADA]= RADA_RGD4CM(phi_init, opts, -A, lambda_RADA, Y0);
        t_RADA =t_RADA +toc(t);
