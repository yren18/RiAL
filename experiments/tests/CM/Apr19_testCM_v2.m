...
[Result1, ~] = RunRep(8000, 50, 50, 0.25, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr);




path = strcat(pwd,'/RiAL_modified/results/CM/');
filename = 'CM_Apr19_data_v2.mat';
