...
inner_min_itr = 50;
tol = 1e-3;
[Result1, ~] = RunRep(5000, 50, 50, 0.25, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr, tol);
[Result2, ~] = RunRep(6000, 50, 50, 0.25, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr, tol);
[Result3, ~] = RunRep(7000, 50, 50, 0.25, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr, tol);
[Result4, ~] = RunRep(8000, 50, 50, 0.25, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr, tol);

tol = 1e-4;
[RResult1, ~] = RunRep(5000, 50, 50, 0.25, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr, tol);
[RResult2, ~] = RunRep(6000, 50, 50, 0.25, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr, tol);
[RResult3, ~] = RunRep(7000, 50, 50, 0.25, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr, tol);
[RResult4, ~] = RunRep(8000, 50, 50, 0.25, 1, nrun, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr, tol);
...
filename = 'CM_Apr20_data_v1.mat';
save(strcat(path,filename));


function [Result, out_ManALM] = RunRep(n, m, r, mu, start, reps, sigma0, sigma0_SD, sparse_param, inner_min_itr, inner_mxitr, tol)
    out_ManALM = 1;
