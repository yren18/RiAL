...
tol = 1e-5;
% [Result1, ~] = RunRep(10000, 50, 30, 1.5, 1, 10, sigma0, sigma0_SD, sparse_param, 20, tol);
% [Result2, ~] = RunRep(10000, 50, 35, 1.5, 1, 10, sigma0, sigma0_SD, sparse_param, 20, tol);
% [Result3, ~] = RunRep(10000, 50, 40, 1.5, 1, 10, sigma0, sigma0_SD, sparse_param, 20, tol);
[Result4, ~] = RunRep(10000, 50, 45, 1.5, 1, 10, sigma0, sigma0_SD, sparse_param, 20, tol);
% [Result5, ~] = RunRep(10000, 50, 50, 1.5, 1, 10, sigma0, sigma0_SD, sparse_param, 20, tol);

% [Result2, ~] = RunRep(5000, 50, 50, 1.00, 1, nrun, sigma0, sigma0_SD, sparse_param, 20);



path = strcat(pwd,'/RiAL_modified/results/');
filename = 'Apr26_data_v1.mat';
save(strcat(path,filename));


function [Result, out_ManALM] = RunRep(n, m, r, mu, start, reps, sigma0, sigma0_SD, sparse_param, inner_min_itr, tol)
    out_ManALM = 1;
