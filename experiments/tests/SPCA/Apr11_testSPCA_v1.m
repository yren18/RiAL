...
tol = 1e-5;
[Result1, ~] = RunRep(12500, 50, 50, 1.5, 1, 10, sigma0, sigma0_SD, sparse_param, 20, tol);
[Result2, ~] = RunRep(15000, 50, 50, 1.5, 1, 10, sigma0, sigma0_SD, sparse_param, 20, tol);
[Result3, ~] = RunRep(17500, 50, 50, 1.5, 1, 10, sigma0, sigma0_SD, sparse_param, 20, tol);




path = strcat(pwd,'/RiAL_modified/results/SPCA/');
filename = 'SPCA_Apr11_data_v1.mat';
