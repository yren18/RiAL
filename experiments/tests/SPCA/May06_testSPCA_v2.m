...
tol = 1e-6;
[Result1, ~] = RunRep(10000, 50, 50, 1.5, 1, 10, sigma0, sigma0_SD, sparse_param, 20, tol);
[Result2, ~] = RunRep(20000, 50, 50, 1.5, 1, 10, sigma0, sigma0_SD, sparse_param, 20, tol);


tol = 1e-5;
[Result3, ~] = RunRep(10000, 50, 50, 1.5, 1, 10, sigma0, sigma0_SD, sparse_param, 20, tol);
[Result4, ~] = RunRep(20000, 50, 50, 1.5, 1, 10, sigma0, sigma0_SD, sparse_param, 20, tol);
...
function [Result, out_ManALM] = RunRep(n, m, r, mu, start, reps, sigma0, sigma0_SD, sparse_param, inner_min_itr, tol)
    ...
    for num = start:reps
        ...
        t_RADA = 0;
        t = tic;
        [U_RADA, out_RADA]= RADA_PGD4SPCA(phi_init, opts, A, lambda_RADA, Y0);
        t_RADA =t_RADA +toc(t);
